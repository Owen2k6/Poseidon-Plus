...
public class CraftingManager {
    ...
    private CraftingManager() {
        ...
        this.registerShapedRecipe(new ItemStack(Block.PISTON, 1), new Object[] { "TTT", "#X#", "#R#", '#', Block.COBBLESTONE, 'X', Item.IRON_INGOT, 'R', Item.REDSTONE, Character.valueOf('T'), Block.WOOD});
        ...
        this.b.sort(new RecipeSorter(this));
